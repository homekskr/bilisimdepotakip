-- BASİTLEŞTİRİLMİŞ ÇÖZÜM: Sadece zorunlu sütunlarla admin oluştur
...
BEGIN
  ...
  -- public.profiles tablosuna admin profili ekle (SADECE ZORUNLU SÜTUNLAR)
...
-- TAMAMLANDI!
-- Artık index.html dosyanızı açıp uygulamaya giriş yapabilirsiniz.
